...
import { Wallet, PlusCircle, Search, AlertCircle, CheckCircle2 } from 'lucide-react';
...
const Loans = () => {
  ...
  // Fetch Employees for Application Select (Admins/HR only)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loanList.length > 0 ? (
          ...
          <div className="lg:col-span-2 py-20 bg-base-100 rounded-3xl border-2 border-dashed border-base-300 flex flex-col items-center justify-center text-center opacity-30">
            ...
            <p className="text-xl font-bold italic">No loan records available.</p>
          </div>
        )}
      </div>
